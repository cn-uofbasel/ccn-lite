...
$CCNL_HOME/src/util/ccn-lite-ctrl -x /tmp/mgmt2.sock addContentToCache $CCNL_HOME/test/nfn/iottlv/computation_content.iottlv | $CCNL_HOME/src/util/ccn-lite-ccnb2xml
