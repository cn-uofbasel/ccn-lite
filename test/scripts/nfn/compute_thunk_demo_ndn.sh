...
$CCNL_HOME/util/ccn-lite-peek -s 2 -u 127.0.0.1/9000 -w 100 "call 1 /test/data|THUNK|NFN"  | $CCNL_HOME/util/ccn-lite-pktdump

sleep 5

$CCNL_HOME/util/ccn-lite-peek -s 2 -u 127.0.0.1/9000 -w 100 "call 1 /test/data|NFN" | $CCNL_HOME/util/ccn-lite-pktdump
