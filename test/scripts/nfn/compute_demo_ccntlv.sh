...
$CCNL_HOME/util/ccn-lite-ctrl -x /tmp/mgmt1.sock prefixreg /test 2 ccnx2014| $CCNL_HOME/util/ccn-lite-ccnb2xml
$CCNL_HOME/util/ccn-lite-ctrl -x /tmp/mgmt2.sock prefixreg /COMPUTE 2 ccnx2014 | $CCNL_HOME/util/ccn-lite-ccnb2xml
...
$CCNL_HOME/util/ccn-lite-peek -s ccnx2014 -u 127.0.0.1/9000 -w 100 "" "call 1 /test/data" | $CCNL_HOME/util/ccn-lite-pktdump
