...
# ccn-lite/test/scripts/interop-SYNoEth-XLLX-a.sh
...
## This is host A in the following setup
##
## +-------------------------+     +--------------------------+
## | A                       |     |                        B |
...
REMOTEMAC=ff:ff:ff:ff:ff:ff # better put the real MAC address of B for unicast
