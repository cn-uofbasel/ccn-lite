...
$CCNL_HOME/util/ccn-lite-ctrl -x $UXA setfrag $FACEID seqd2012 600 | $CCNL_HOME/util/ccn-lite-ccnb2xml | grep ACTION
...
$CCNL_HOME/util/ccn-lite-ctrl -x $UXB setfrag $FACEID seqd2012 600 | $CCNL_HOME/util/ccn-lite-ccnb2xml | grep ACTION
...
$CCNL_HOME/util/ccn-lite-peek -u 127.0.0.1/$PORTA /ccnx/0.7.1/doc/technical/NameEnumerationProtocol.txt | $CCNL_HOME/util/ccn-lite-ccnb2hex
