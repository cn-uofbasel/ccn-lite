...
#define CCNL_DEFAULT_MAX_CACHE_ENTRIES	0 // no network memory for content
#define CCNL_MAX_NONCES			256
...
#define CCNL_DTAG_ENCAPS	99003 // which fragmentation protocol
#define CCNL_DTAG_FACEFLAGS	99004 //
#define CCNL_DTAG_DEVINSTANCE	99005 // adding/removing a device/interface
#define CCNL_DTAG_DEVNAME	99006 // which device (eth0, wlan0)
...
#define CCNL_DTAG_FRAG_OSEQN	(CCNL_DTAG_FRAGMENT+2)
#define CCNL_DTAG_FRAG_OLOSS	(CCNL_DTAG_FRAGMENT+3)
#define CCNL_DTAG_FRAG_YSEQN	(CCNL_DTAG_FRAGMENT+4)
